        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngineHours = table.Column<float>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryPoint = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CargosInOrder", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CargosInOrder_Cargos_CargoId",
                        column: x => x.CargoId,
                        principalTable: "Cargos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CargosInOrder_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CargosInOrder_CargoId",
                table: "CargosInOrder",
                column: "CargoId");

            migrationBuilder.CreateIndex(
                name: "IX_CargosInOrder_OrderId",
                table: "CargosInOrder",
                column: "OrderId");
